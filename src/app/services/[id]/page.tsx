    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <Link
                ...
                className="text-xs font-medium px-2.5 py-1 rounded-full bg-muted text-muted-fg hover:bg-accent transition-colors"
              >
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {service.tags.map((tag: string) => (
                <span
                  key={tag}
                  className="text-xs px-3 py-1.5 rounded-full bg-muted text-muted-fg"
                >
                  #{tag}
                </span>
              ))}
            ...
            <div>
              ...
              <div className="space-y-4">
                {serviceReviews.map((review) => (
                  <div key={review.id} className="p-5 rounded-2xl border border-card-border bg-card-bg">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-muted flex items-center justify-center text-sm font-medium text-muted-fg">
                          {review.user_avatar}
                        </div>
                        <div>
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-24 p-6 rounded-2xl border border-card-border bg-card-bg shadow-sm">
            ...
            <Link
              ...
              className="block w-full bg-foreground text-background font-semibold py-3 rounded-xl hover:opacity-90 transition-all text-center mb-3 btn-3d"
            >
              Contratar Servicio
            </Link>
      ...
      {relatedServices && relatedServices.length > 0 && (
        <div className="mt-16">
          <h2 className="text-2xl font-bold text-foreground mb-6">Servicios relacionados</h2>
